...
class StandardImproved(Standard):
    ...
    def __init__(self,**kwargs):
        ...
        kwarg = {'label' : ['time [s]', 'y(t)= f(t)'], 'text.color':'k' ,'box':'#555555', 'fontsize':'16', 'legendfontsize':'12' , 'labelsize':[16,14,14] , 'subplot.bottom':0.175 ,**kwargs}   
      
        self.parameters.update(kwarg)
       
        if 'axeslabel' not in self.parameters.keys():
            self.parameters['axeslabel'] = 'k'
        if 'title.color' not in self.parameters.keys():
            self.parameters['title.color'] = 'k'
        if 'xtickcolor' not in self.parameters.keys():
...
class Elsevier(StandardImproved):
    ...
    def __init__(self, **kwargs):
        ...
        fontname = os.path.join(matplotlib.get_data_path(),
                            'fonts', 'otf', 'Gulliver-Regular.otf')

       
        self.parameters['font'] = 'Gulliver-Regular'
        #self.parameters['font'] = 'Gulliver'
        if 'grid.alpha' not in self.parameters.keys():
            self.parameters['grid.alpha'] = '1'
        if 'box' not in self.parameters.keys():
...
class TexMathpazoBeamer(TexMathpazo):
    ...
    def __init__(self, **kwargs):
        ...
        kwarg = {'package' : [r'\usepackage{amsmath}' , r'\usepackage{mathpazo}'] , 'text':True , **kwargs }   
        self.parameters.update(kwarg)
        ...
        if 'scheme' not in self.parameters.keys():
            self.parameters['scheme'] = 'gg'
        self.parameters['fontsize'] = 20.0
        self.parameters['legendfontsize'] =16.0
        self.parameters['xtick.labelsize'] = 18
        self.parameters['ytick.labelsize'] = 18
        #self.parameters['gridcolor'] = 'gray'
        self.parameters['label'] = ['$time [s]$', '$y(t)$']
        #self.parameters['legend.loc'] = 'upper left'
        self.parameters['text.colors'] = 'k'
...
class Beamer(StandardImproved):
     ...
     def __init__(self , **kwargs):
        ...
        self.parameters['font'] = 'Helvetica-Regular'
        self.parameters['box'] = '#2E3436'    #'gray' 
        self.parameters['axeslabel'] = '#2E3436'
        self.parameters['fontsize'] = 20.0
        self.parameters['legendfontsize'] =18.0
        self.parameters['xtick.labelsize'] = 18
        self.parameters['ytick.labelsize'] = 18
        if 'scheme' not in self.parameters.keys():
            self.parameters['scheme'] = 'nb2'
        self.parameters['legend.loc'] = 'upper right'
        self.parameters['lines.linewidth'] = 6
...
class TexPaper(StandardImproved):
    ...
    def __init__(self ,**kwargs):
        ...
        #self.parameters['grid.linestyle'] = '--' 
        #self.parameters['grid.alpha'] = '1'
        self.parameters['box'] = 'black' 
        self.parameters['axeslabel'] = 'black'  #'#2E3436'
        self.parameters['xtickcolor'] = 'black' 
        self.parameters['ytickcolor'] = 'black' 
        #self.parameters['linestyle'] = 'paper'
        #if 'scheme' not in self.parameters.keys():
        #    self.parameters['scheme'] = 'grayscale'
        self.parameters['legend.loc'] = 'upper right'
...
class SansItalic(StandardImproved):
    ...
    def __init__(self, **kwargs):
        ...
        self.parameters['box'] = 'gray' 
        self.parameters['axeslabel'] = 'black'
        self.parameters['xtickcolor'] = 'gray' 
        self.parameters['ytickcolor'] = 'gray' 
        self.parameters['fontsize'] = 14.0
        self.parameters['legendfontsize'] =12.0
        ...
        self.parameters['grid.linewidth'] = 0.6
        #self.parameters['legend.axespad'] = 0. 
        self.parameters['axes.linewidth'] = 0.6
...
class TexOld(StandardImproved):

    def __init__(self ,**kwargs):
        
        self.parameters = kwargs
      
        kwarg = {'text':'True', 'box':'black', 'axeslabel':'#000000', 'fontsize':'22', 'legendfontsize':'18' , 'labelsize':[20,18,18]}
        self.parameters.update(kwarg)
    
        self.parameters['grid.alpha'] = '0'
        self.parameters['box'] = 'black' 
        self.parameters['axeslabel'] = 'black'
        self.parameters['xtickcolor'] = 'black' 
        self.parameters['ytickcolor'] = 'black' 
        ...
        self.parameters['cycle']  = self.cycle('1')
        self.parameters['subplot.bottom'] = 0.145
        self.parameters['axes.linewidth'] = 2.5
        self.parameters['title.colors'] = 'black'
        self.parameters['gridcolor'] = 'gray'
        self.parameters['grid.linewidth'] = 1
        self.parameters['grid.linestyle'] = '-' 
        self.parameters['tick.MajW'] = 2
        self.parameters['tick.minW'] = 2
        self.parameters['legendEdgeColor'] = 'black'
        self.parameters['font.weight'] = 'bold'
        self.parameters['axes.labelweight'] = 'bold'
        self.parameters['xtick.direction'] = 'in'
        self.parameters['ytick.direction'] = 'in'
        super().__init__(**self.parameters )
...
class SansItalic_paper(StandardImproved):
    ...
    def __init__(self, **kwargs):
        ...
        self.parameters['grid.dashes'] = (8,8)       
        self.parameters['title.colors'] = '#2E3436'
        self.parameters['legendEdgeColor'] = 'None'
        #self.parameters['legend.bbox'] = (1,0.5)
        #self.parameters['legend.loc'] = 'best' 
        if 'scheme' not in self.parameters.keys():
            self.parameters['scheme'] = 'nb2'   #'nb2' #'grayimproved' #'nb2'
        ...
        #self.parameters['legend.axespad'] = 0. 
        self.parameters['axes.linewidth'] = 0.6
        self.parameters['legend.borderpad'] = 0
        super().__init__(**self.parameters )
    
       # #82A6C7 #DAADEB #99D366

#---------------------------------------------------------------------------------------------------------
class SansItalic_II(StandardImproved):
    ...
    def __init__(self, **kwargs):
        ...
        self.parameters['legendfontsize'] =18.0
        self.parameters['xtick.labelsize'] = 20
        self.parameters['ytick.labelsize'] = 20
        self.parameters['scheme'] = 'nb'
        #self.parameters['gridcolor'] = 'gray'   # '#dddddd' # 'gray'  #  #  #
        #self.parameters['legend.loc'] = 'upper left'
        self.parameters['lines.linewidth'] = 3
